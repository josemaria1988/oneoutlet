                ...
                <div class="col-12 mt-3">
                    <div class="cart-summary">
                        ...
                        <div class="promo-wrap" style="display: none;">
                            <input type="text" placeholder="{{ trans('labels.enter_email') }}" name="customer_email" id="customer_email" required="" value="oneoutlet@oneoutlet.site">
                        </div>
                        <div class="promo-wrap input-group">
                            ...
                            <input type="text" class="form-control form_text" placeholder="{{ trans('messages.enter_contact_number_required') }}" name="customer_mobile" id="customer_mobile" required="">
                        </div>
            ...
            <div class="col-lg-4 mt-3">
                ...
                <div class="cart-summary">
                    ...
                    <div class="list-group list-group-sm mt-3">
                        ...
                        @if($payment->payment_name != "COD" && $payment->payment_name != "PayPal")
                            @continue
                        @endif
                        <div class="list-group-item">
                            <!-- Radio -->
                            <div class="custom-control custom-radio">
                                ...
                                <label class="custom-control-label font-size-sm text-body text-nowrap" for="{{$payment->payment_name}}">
                                    ...
                                    <input name="razorpay" id="razorpay" value="{{$payment->public_key}}">
                                    @endif
                                    @if($payment->payment_name == "Stripe")
                                    <input name="stripe" id="stripe" value="{{$payment->public_key}}">
                                    @endif
                                    @if($payment->payment_name == "Flutterwave")
                                    <input name="flutterwavekey" id="flutterwavekey" value="{{$payment->public_key}}">
                                    @endif
                                    @if($payment->payment_name == "Paystack")
                                    <input name="paystackkey" id="paystackkey" value="{{$payment->public_key}}">
                                    @endif
                        ...
                        success: function(response) {
                            if (response.status == 1) {
                                ...
                                if (payment_type == "RazorPay") {
                                    ...
                                    var options = {
                                        "key": $('#razorpay').val(),
                                        "amount": (parseInt(grand_total * 10000)), // 2000 paise = INR 20
                                ...
                                if (payment_type == 'PayPal') {
                                    $.ajax({
                                        ...
                                        url: "{{ URL::to('/orders/whatsapporder_paypal') }}",
                                        data: {
                                            payment_token: "",
                                            business: business,
                                            item_name: item_name,
                                        ...
                                        success: function(response) {
                                            if (response.status == 1) {
                                               ...
                                               $('#payer_email').val(message.email);
                                               $('#payer_name').val(message.name);
                                               $("#amount_paypal").val(message.amount);
                                               $("#notify_url").val(message.notify);
                                               $("#cancel_return").val(message.cancel);
                                               $("#return_pay").val(message.return);
                                               $('#payment-form').submit();
                                               return true;
                                            }
                                        },
