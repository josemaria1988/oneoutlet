                ...
                <div class="shop-header mb-35">
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-12 d-flex flex-column flex-sm-row justify-content-between align-items-left align-items-sm-center" >
                            ...
                            <div style="background-color:#000; padding-left:10px;padding-right:10px; padding-vertical:10px">
                            <p id="resultPages" class="result-show-message" style="font-weight:700; color:#FFF ">
