            ...
            <div class="col-md-6 foodm">
                ...
                <div class="col-md-12 foodm">
                    ...
                    <div class="col-md-10 foodm" style="padding-left: 30px">
                        <div class="form-group form-group-lg form-float">
                            <div class="form-line">
                                <input type="text" name="payMobApiKey" id="payMobApiKey" class="q-form" placeholder="" maxlength="1000" value="{{$payMobApiKey}}">
                                <label class="form-label">{{$lang->get(453)}}</label>       {{--"Insert Api key"--}}
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-12 foodm">
                    ...
                    <div class="col-md-10 foodm" style="padding-left: 30px">
                        <div class="form-group form-group-lg form-float">
                            <div class="form-line">
                                <input type="text" name="payMobFrame" id="payMobFrame" class="q-form" placeholder="" maxlength="1000" value="{{$payMobFrame}}">
                ...
                <div class="col-md-12 foodm">
                    ...
                    <div class="col-md-10 foodm" style="padding-left: 30px">
                        <div class="form-group form-group-lg form-float">
                            <div class="form-line">
                                <input type="text" name="payMobIntegrationId" id="payMobIntegrationId" class="q-form" placeholder="" maxlength="1000" value="{{$payMobIntegrationId}}">
...
{{--                        <h5>{{$lang->get(614)}}</h5>        --}}{{--Access Token--}}
                    ...
                    <div class="col-md-10 foodm" style="padding-left: 30px">
                        <div class="form-group form-group-lg form-float">
                            <div class="form-line">
                                <input type="text" name="MercadoPagoAccessToken" id="MercadoPagoAccessToken" class="q-form" placeholder="" maxlength="1000" value="{{$MercadoPagoAccessToken}}">
{{--                                <label class="form-label">{{$lang->get(616)}}</label>       --}}{{--Insert Access Token--}}
                                <label class="form-label">Insert Access Token</label>
                            </div>
                        </div>
                    </div>
                </div>
...
{{--                        <h5>{{$lang->get(615)}}</h5>        {{--Public Key--}}
                    ...
                    <div class="col-md-10 foodm" style="padding-left: 30px">
                        <div class="form-group form-group-lg form-float">
                            <div class="form-line">
                                <input type="text" name="MercadoPagoPublicKey" id="MercadoPagoPublicKey" class="q-form" placeholder="" maxlength="1000" value="{{$MercadoPagoPublicKey}}">
{{--                                <label class="form-label">{{$lang->get(617)}}</label>       --}}{{--Insert Public Key--}}
                                <label class="form-label">Insert Public Key</label>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-6 foodm">
                ...
                <div class="col-md-12 foodm">
                    ...
                    <div class="col-md-10 foodm" style="padding-left: 30px">
                        <div class="form-group form-group-lg form-float">
                            <div class="form-line">
                                <input type="text" name="FlutterWaveEncryptionKey" id="FlutterWaveEncryptionKey" class="q-form" placeholder="" maxlength="1000" value="{{$FlutterWaveEncryptionKey}}">
                ...
                <div class="col-md-12 foodm">
                    ...
                    <div class="col-md-10 foodm" style="padding-left: 30px">
                        <div class="form-group form-group-lg form-float">
                            <div class="form-line">
                                <input type="text" name="FlutterWavePublicKey" id="FlutterWavePublicKey" class="q-form" placeholder="" maxlength="1000" value="{{$FlutterWavePublicKey}}">
                                <label class="form-label">{{$lang->get(617)}}</label>       {{--Insert Public Key--}}
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    if ('{{$payMobEnable}}' == "true") {
        ...
        document.getElementById('payMobEnable').innerHTML = "<img src=\"img/check_on.png\" width=\"25px\">&nbsp Enable PayMob";
    }else{
        var payMobEnable = false;
        document.getElementById('payMobEnable').innerHTML = "<img src=\"img/check_off.png\" width=\"25px\">&nbsp Enable PayMob";
    }
    ...
    function onCheckClick(id){
        ...
        if (id == 'payMobEnable') {
            ...
            document.getElementById(id).innerHTML = "<img src=\"img/check_"+value+".png\" width=\"25px\">&nbsp Enable PayMob";
        }
    ...
    function save(){
        ...
        // PayMob
        var payMobApiKey = document.getElementById("payMobApiKey").value;
        var payMobFrame = document.getElementById("payMobFrame").value;
        var payMobIntegrationId = document.getElementById("payMobIntegrationId").value;
        if (payMobEnable) {
            if (payMobApiKey.length == 0)
                return showNotification("bg-red", "The PayMob Api Key field is required", "bottom", "center", "", "");
            if (payMobFrame.length == 0)
                return showNotification("bg-red", "The PayMob Frame field is required", "bottom", "center", "", "");
            if (payMobIntegrationId.length == 0)
                return showNotification("bg-red", "The PayMob IntegrationId field is required", "bottom", "center", "", "");
        }
        // MercadoPago
