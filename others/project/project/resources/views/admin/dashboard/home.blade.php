					...
					<div class="media">
						<div class="media-body white">
							<div class="row justify-content-space-evenly">
								<div class="media-body white">
                                @if($isMob == "1")
                                <a href="whatsapp://send/send?text={{URL::to('/')}}/{{Auth::user()->slug}}" target="_blank" class="btn btn-social btn-min-width btn-adn-flat mr-2 mb-2 btn-adn"><i class="fa-brands fa fa-whatsapp text-wa-color"> {{trans('labels.whatsapp')}}</a>
                                @else
