            ...
            <div class="nav-container">
               <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
                  ...
                  <li class="{{ request()->is('admin/payments*') ? 'active' : '' }}">
                     <a href="{{ URL::to('/admin/payments')}}" class="menu-item"><i class="fa fa-credit-card"></i><span data-i18n="" class="menu-title">{{ trans('labels.payments') }}</span><span class="tag badge badge-pill badge-danger float-right mr-1 mt-1">Add-on</span></a>
                  </li>
                  @endif
                  ...
                  <li class="{{ request()->is('admin/apps*') ? 'active' : '' }}">
                     <a href="{{ URL::to('/admin/apps')}}" class="menu-item"><i class="fa fa-puzzle-piece"></i><span data-i18n="" class="menu-title">{{ trans('labels.apps') }}</span><span class="tag badge badge-pill badge-danger float-right mr-1 mt-1">Add-on</span></a>
                  </li>
                  ...
                  <li class="{{ request()->is('vendor/payments*') ? 'active' : '' }}">
                     <a href="{{ URL::to('/vendor/payments')}}" class="menu-item"><i class="fa fa-credit-card"></i><span data-i18n="" class="menu-title">{{ trans('labels.payments') }}</span><span class="tag badge badge-pill badge-danger float-right mr-1 mt-1">Add-on</span></a>
                  </li>
                  @endif
