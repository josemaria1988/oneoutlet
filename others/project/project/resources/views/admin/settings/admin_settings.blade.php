               ...
               <div class="card-block">
                  ...
                  <div class="row d-flex">
                     <div class="col align-self-center">
                        <p class="mb-1">Order No : <span class="pull-right text-primary">{order_no}</span></p>
                        <p class="mb-1">Item Variable : <span class="pull-right text-primary">{item_variable}</span></p>
                        <p class="mb-1">Subtotal : <span class="pull-right text-primary">{sub_total}</span></p>
                        <p class="mb-1">Total Tax : <span class="pull-right text-primary">{total_tax}</span></p>
                        <p class="mb-1">Delivery charge : <span class="pull-right text-primary">{delivery_charge}</span></p>
                        <p class="mb-1">Discount amount : <span class="pull-right text-primary">{discount_amount}</span></p>
                        <p class="mb-1">Grand total : <span class="pull-right text-primary">{grand_total}</span></p>
                        <p class="mb-1">Notes : <span class="pull-right text-primary">{notes}</span></p>
                        <p class="mb-1">Customer name : <span class="pull-right text-primary">{customer_name}</span></p>
                        <p class="mb-1">Customer mobile : <span class="pull-right text-primary">{customer_mobile}</span></p>
                        <p class="mb-1">Time : <span class="pull-right text-primary">{time}</span></p>
                        <p class="mb-1">Payment type : <span class="pull-right text-primary">{payment_type}</span></p>
                        <p class="mb-1">Store name : <span class="pull-right text-primary">{store_name}</span></p>
                        <p class="mb-1">Track order URL : <span class="pull-right text-primary">{track_order_url}</span></p>
                        <p class="mb-1">Store URL : <span class="pull-right text-primary">{store_url}</span></p>
                     </div>
                     <div class="col align-self-center">
                        <p class="mb-1">Address : <span class="pull-right text-primary">{address}</span></p>
                        <p class="mb-1">Building : <span class="pull-right text-primary">{building}</span></p>
                        <p class="mb-1">Landmark : <span class="pull-right text-primary">{landmark}</span></p>
                        <p class="mb-1">Postal code : <span class="pull-right text-primary">{postal_code}</span></p>
                        <p class="mb-1">Date : <span class="pull-right text-primary">{date}</span></p>
                        <p class="mb-1">Delivery type : <span class="pull-right text-primary">{delivery_type}</span></p>
                        <hr>
                        <h5 class="text-center">{{trans('labels.item_variable')}}</h5>
                        <hr>
                        <p class="mb-1">Item name : <span class="pull-right text-primary">{item_name}</span></p>
                        <p class="mb-1">QTY : <span class="pull-right text-primary">{qty}</span></p>
                        <p class="mb-1">Variants : <span class="pull-right text-primary">{variantsdata}</span></p>
                        <p class="mb-1">Item price : <span class="pull-right text-primary">{item_price}</span></p>
