...
<section id="basic-form-layouts">
    <div class="row">
        <div class="col-sm-12">
            <div class="content-header">{{$pdata->payment_name}} {{trans('labels.payment_configuration')}} </div>
        </div>
    </div>
                    ...
                    <div class="px-3">
                        <form class="form" method="POST" action="{{URL::to('admin/payments/update-'.$pdata->_id)}}" enctype="multipart/form-data">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="environment" name="environment" class="form-control">
                                        <option selected value="0">{{trans('labels.production')}}</option>
                                        <option value="1">{{trans('labels.sandbox')}}</option>
                                    </select>
                                </div>
                            ...
                            <div class="form-actions center">
                                <a type="button" class="btn btn-raised btn-warning mr-1" href="{{ URL::to('/admin/payments')}}"><i class="ft-x"></i> {{trans('labels.cancel')}}</a>
