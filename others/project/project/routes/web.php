...
Route::group(['namespace' => "front"], function () {
    ...
    Route::get('/landing', [HomeController::class, 'landing'])->name('front.landing.index');
...
Route::group(['middleware' => 'UserMiddleware', 'prefix' => "user"], function () {
    ...
    Route::post('/payment/app/notify/success/{token}', [UserController::class, 'success'])->name('user.notify.success');
});